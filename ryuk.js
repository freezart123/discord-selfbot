...
bot.on('message', message => {
    ...
    message.channel.sendMessage("ﹺ　　　　　　　　　　　　　　　　　　　　　　　　　ﹺﹺ　　　　　　　　　　　　　　　　　　　　　　　　　ﹺﹺ　　　　　　　　　　　　　　　　　　　　　　　　　ﹺﹺ　　　　　　　　　　　　　　　　　　　　　　　　　ﹺﹺ　　　　　　　　　　　　　　　　　　　　　　　　　ﹺ");
        ...
        .addField(prefix+"laugh1", "`Laugh x1`")
        .addField(prefix+"laugh2", "`Laugh x2`")
        .addField(prefix+"laugh3", "`Laugh x3`")
    ...
    }else if(message.content === prefix+'laugh1'){
        message.delete()
    ...
    }else if(message.content === prefix+'laugh2'){
        message.delete()
        var r2_embed = new Discord.RichEmbed()
        .setColor("BLACK")
        .setTitle("I laughed X2")
    ...
    }else if(message.content === prefix+'laugh3'){
        message.delete()
        ...
        .addField(prefix+"creatct + name", "`create 10 text channels`")
        .addField(prefix+"creatcv + name", "`create 10 channels voice`")
        ...
        .setColor("BLACK").setThumbnail(sicon)
